    ...
    if __name__ == "__main__":
         try:
             ...
             dump(result[55:])
              ...
              print(singleIp,": Не могу соединить, жопная ситуация")
         except ConnectionRefusedError:
              print(singleIp,": Роутер гнида, отказался соединять")
         except ConnectionResetError:
              print(singleIp,": Сброс соединения ip говно, нужно проксить")
         except IndexError:
              print(singleIp,": Юзвери перепрятаны")
         except socket.error:
             print(singleIp,": Хрень с сокетом")      
